...
<ul class="research-working-papers">
  <li>
    <div class="research-entry">
      ...
      </details><a class="research-entry__pdf-placeholder" href="/files/paper1.pdf?v=20260831" target="_blank" rel="noopener noreferrer" aria-label="PDF" title="PDF"><i class="fas fa-file-pdf" aria-hidden="true"></i><span>PDF</span></a></div>
  ...
  <li>
    <div class="research-entry">
      <div class="research-entry__titleline"><span class="research-entry__title"><span class="research-entry__title-main">Cross-Ethnic Social Interactions and Multilevel Belonging Among First-Generation Immigrants in Quebec</span> <span class="research-entry__coauthor">(with Antoine Bilodeau)</span></span> <details class="research-entry__details research-entry__details--inline">
        <summary class="research-entry__summary"><i class="fas fa-file-alt" aria-hidden="true"></i><span>Abstract</span></summary>
  ...
  <li>
    <div class="research-entry">
      <div class="research-entry__titleline"><span class="research-entry__title"><span class="research-entry__title-main">Is Six Degrees of Separation Five Too Many? A Research Note about Extended Contact</span> <span class="research-entry__coauthor">(with Cara Wong)</span></span> <details class="research-entry__details research-entry__details--inline">
        <summary class="research-entry__summary"><i class="fas fa-file-alt" aria-hidden="true"></i><span>Abstract</span></summary>
        <p class="research-entry__abstract">According to extended contact theory, knowing an ingroup member who has outgroup friends can reduce prejudice even without direct intergroup contact. Over a hundred articles have been published in social psychology journals, and they tend to show positive effects, albeit smaller than those of direct contact. However, the majority of this work is correlational, and to our knowledge, there have been few field experiments designed to study the effect of extended contact. To validate the theory, we first identify three causal mechanisms through which extended contact could operate: direct attitude influence, norm perception, and information transmission. We then argue that several well-identified causal studies inadvertently test these mechanisms and that they fail those tests when it comes to political attitudes. Drawing on field experiments of voter mobilization and observational studies of military conscription, we find that behavioral spillover requires physical cohabitation and a proximate act, while attitudinal spillover fails even among women most plausibly in contact with conscripted men. These findings raise questions about the external validity of the extended contact literature and call for more rigorous causal tests of the theory.</p>
      </details></div>
    </div>
  </li>
  <li>
    <div class="research-entry">
      <div class="research-entry__titleline"><span class="research-entry__title"><span class="research-entry__title-main">Inter-Minority Attitudes Among Refugees in Germany </span> <span class="research-entry__coauthor">(with Christian Czymara and Irena Kogan)</span></span> <details class="research-entry__details research-entry__details--inline">
        <summary class="research-entry__summary"><i class="fas fa-file-alt" aria-hidden="true"></i><span>Abstract</span></summary>
        <p class="research-entry__abstract">Research on attitudes toward immigrants and refugees has focused overwhelmingly on the perceptions of native majorities, leaving how minority groups evaluate one another comparatively underexplored. Using original survey data on young male Syrian and Afghan refugees in Germany (PARFORM), we examine feeling-thermometer ratings of six target groups: the German majority, the respondents’ own group in Germany and in their home country, the respective other refugee group, Turks, and Ukrainian refugees. We argue that structural differences in the two groups’ integration (faster asylum procedures, more secure protection status, and greater labor-market access among Syrians) can explain intergroup boundaries among refugees. Consistent with the reflective distinctiveness hypothesis, Syrians display stronger ingroup favoritism than Afghans and rate Afghans more negatively than vice versa, as Afghans pose a reputational threat to the more advantageously positioned group. This asymmetry does not appear for Ukrainians, who differ from both groups in religious and demographic profile. Notably, Syrians and Afghans also do not differ in their warmth toward the German majority: structural advantages are an important factor that can explain how refugees see themselves and each other, but not how they see the host society. These findings underscore that ethnic and migration hierarchies are constructed not only from above, but also from below.</p>
      </details></div>
    </div>
  </li>
</ul>
...
<ul class="research-working-papers">
  ...
  <li>
    <div class="research-entry">
      ...
      <ul class="research-entry__presented">
        <li><em>Presented at <a href="/updates/2026-04-23-mpsa-annual-meeting/">MPSA 2026</a>, <a href="/updates/2026-09-03-apsa-annual-meeting-and-centennial-center-research-grant/">APSA 2026</a></em></li>
